...
import { DescriptionText, DescriptionTitle, DescriptionWrap, QuestionsForm, QuestionsFormTitle, SCTOQuestionsButton } from "../SurveyCTOQuestions/SurveyCTOQuestions.styled";
